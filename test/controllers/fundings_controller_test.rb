...
class FundingsControllerTest < ActionController::TestCase
  ...
  test "should create funding" do
    assert_difference('Funding.count') do
      post :create, funding: { adress: @funding.adress, description: @funding.description, focus: @funding.focus, name: @funding.name, thumbnail: @funding.thumbnail, type: @funding.type, url: @funding.url }
    end
  ...
  test "should update funding" do
    patch :update, id: @funding, funding: { adress: @funding.adress, description: @funding.description, focus: @funding.focus, name: @funding.name, thumbnail: @funding.thumbnail, type: @funding.type, url: @funding.url }
    assert_redirected_to funding_path(assigns(:funding))
  end
